...
public class ComwayGameOfLife {
	...
	/*
	 * 
	 * Data representing the grid in 1d format. Specified as byte to allow for
	 * multiple
	 * 
	 * phases.
	 * 
	...
	public ComwayGameOfLife(int width, int height) {
		this.width = width;
		this.height = height;
	...
	public static void main(String[] args) {
		ComwayGameOfLife cm = new ComwayGameOfLife();
		cm.randomSeed();
	}
